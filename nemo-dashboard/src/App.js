    ...
    <div className="font-sans text-center border-4 border-blue-500 p-4 bg-gray-100 w-full min-h-screen flex flex-col items-center justify-center App">
      ...
      <div className="flex flex-wrap justify-between gap-4 max-w-4xl w-full">
        <div className="flex-1 border-2 border-blue-500 p-4">
          ...
          <img
            src={imageSrc || 'https://www.rollingstone.com/wp-content/uploads/2023/05/Finding-Nemo-Anniversary.jpg?w=1581&h=1054&crop=1.jpg'}
            alt="Nemo's House"
          ...
          <div className="text-center">
            ...
            <div className="inline-flex items-center gap-2">
              <div className="relative inline-block w-16 h-8">
                <input id="switch-component-on" type="checkbox" className="peer appearance-none w-16 h-9 bg-slate-500 rounded-full cursor-pointer checked:bg-blue-800 cursor-pointer transition-colors duration-300" />
                <label htmlFor="switch-component-on" className="absolute top-1 left-1 right-1 down-1 w-7 h-7 bg-white rounded-full border border-slate-300 shadow-sm transition-transform duration-300 peer-checked:translate-x-8 peer-checked:border-slate-800 cursor-pointer">
                </label>
              </div>
            </div>
          </div>
